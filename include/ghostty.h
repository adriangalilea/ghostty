...
typedef enum {
  ...
  GHOSTTY_ACTION_VIGIL_NEXT,
  GHOSTTY_ACTION_VIGIL_DETACH_WINDOW,
  GHOSTTY_ACTION_VIGIL_NEW_SESSION,
  GHOSTTY_ACTION_VIGIL_OVERVIEW,
  GHOSTTY_ACTION_VIGIL_CYCLE,
  GHOSTTY_ACTION_VIGIL_NEXT_FLOATING,
  GHOSTTY_ACTION_VIGIL_KILL,
  GHOSTTY_ACTION_VIGIL_PERSIST,
  GHOSTTY_ACTION_VIGIL_FLOAT,
...
GHOSTTY_API bool ghostty_surface_vigil_dump(ghostty_surface_t,
                                               const char*,
                                               uintptr_t);
